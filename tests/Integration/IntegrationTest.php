...
class IntegrationTest extends PHPStanTestCase
{
    ...
    public static function dataIntegrationTests(): iterable
    {
        ...
        yield [
            ...
            [
                15 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::firstWhere() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                16 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::firstWhere() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'id\'|\'unionNotExisting\' given.'],
                17 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::where() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                19 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::where() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                20 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::where() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                24 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::where() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, string given.'],
                25 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::orWhere() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                26 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::orWhere() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'foo\' given.'],
                27 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::orWhere() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, array{foo: \'foo\'} given.'],
                ...
                39 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Builder<App\User>::where() expects array<model property of App\User, mixed>|(Closure(Illuminate\Database\Eloquent\Builder<App\User>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\User, \'roles.foo\' given.'],
            ],
        ];
        ...
        if (version_compare(LARAVEL_VERSION, '11.15.0', '<')) {
            yield [
                ...
                [
                    4 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Relations\HasMany<App\Account>::where() expects array<model property of App\Account, mixed>|(Closure(Illuminate\Database\Eloquent\Relations\HasMany<App\Account>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Account, \'foo\' given.'],
                    ...
                    10 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post>::where() expects array<model property of App\Post, mixed>|(Closure(Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Post, \'foo\' given.'],
                ],
            ];
        ...
        yield [
            ...
            [
                ...
                6 => ['Parameter #1 $attributes of method Illuminate\Database\Eloquent\Relations\HasOneOrMany<App\Account>::firstOrNew() expects array<model property of App\Account, mixed>, array<string, string> given.'],
                7 => ['Parameter #1 $attributes of method Illuminate\Database\Eloquent\Relations\HasOneOrMany<App\Account>::firstOrCreate() expects array<model property of App\Account, mixed>, array<string, string> given.'],
                8 => ['Parameter #1 $attributes of method Illuminate\Database\Eloquent\Relations\HasOneOrMany<App\Account>::createOrFirst() expects array<model property of App\Account, mixed>, array<string, string> given.'],
                9 => ['Parameter #1 $attributes of method Illuminate\Database\Eloquent\Relations\HasOneOrMany<App\Account>::updateOrCreate() expects array<model property of App\Account, mixed>, array<string, string> given.'],
                11 => ['Parameter #1 $column of method Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post>::where() expects array<model property of App\Post, mixed>|(Closure(Illuminate\Database\Eloquent\Relations\BelongsToMany<App\Post>): mixed)|Illuminate\Contracts\Database\Query\Expression|model property of App\Post, \'foo\' given.'],
            ],
        ];
    }
